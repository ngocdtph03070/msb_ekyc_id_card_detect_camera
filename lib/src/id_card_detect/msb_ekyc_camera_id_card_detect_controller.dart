...
class IdCardDetectController extends ValueNotifier<IdCardDetectControllerValue> {
  ///
  /// Event
  Function(dynamic event) _idCardDetectEventHandler;
  Function() _idCardDetectViewCreated;

  BuildContext _context;
  String _idCardFaceType;
  ...
  ///
  /// Constructor.
  IdCardDetectController(BuildContext context, String idCardFaceType,  {
  ...
  bool get isStartCamera => MSBEkycCameraIdCardDetectPlatform.instance.isStartCamera;
  bool get isStartCameraPreview =>
      MSBEkycCameraIdCardDetectPlatform.instance.isStartCameraPreview;

  bool get isOpenFlash => MSBEkycCameraIdCardDetectPlatform.instance.isOpenFlash;

  eventHandler (dynamic event) {
    final Map<dynamic, dynamic> map = event;
    print('id_card_detect_view_event_channel event receive: ' + event.toString());
  ...
  initCamera() async {
    _viewId = await MSBEkycCameraIdCardDetectPlatform.instance.initCamera(_idCardFaceType);
  ...
  Future<String> captureImage() async {
    ...
    var result = await MSBEkycCameraIdCardDetectPlatform.instance.captureImage();
    if (result != null){
      ...
      try {
        ...
        print ('idCardDetectController: error parsing result to json: ' + ex.toString());
      }
